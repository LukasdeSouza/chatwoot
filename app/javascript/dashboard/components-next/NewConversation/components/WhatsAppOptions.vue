...
<template>
  <div class="relative">
    ...
    <div
      ...
      class="absolute top-full mt-1.5 max-h-96 overflow-y-auto left-0 flex flex-col gap-2 p-4 items-center w-[21.875rem] h-auto bg-n-slate-1 border border-n-strong shadow-sm rounded-lg"
    >
