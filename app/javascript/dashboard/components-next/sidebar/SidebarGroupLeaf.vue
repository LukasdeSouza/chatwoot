...
<template>
  ...
  >
    <component
      ...
      :to="to"
      :title="label"
      class="flex h-8 items-center gap-2 px-2 py-1 rounded-lg max-w-[9.438rem] hover:bg-gradient-to-r from-transparent via-n-solid-2/70 to-n-solid-3/70 group"
      :class="{
        'text-n-blue-text active': active,
      }"
    >
      <component
        :is="component"
